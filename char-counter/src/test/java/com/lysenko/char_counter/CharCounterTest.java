...
class CharCounterTest {
	...
	void givenNullThenGetException() {
		assertThrows(NullPointerException.class, () -> charCounter.showResult(null));
	}

	@Test
	void givenEmptyThenGetResult() {
		StringBuilder expected = new StringBuilder("");
		String actual = charCounter.showResult("");
	...
	void givenSynchrophasotronThenGetResult() {
		...
		String actual = charCounter.showResult("synchrophasotron");
		assertEquals(expected.toString(), actual);
	}
	...
	void givenCollectionFrameworkThenGetResult() {
		...
		String actual = charCounter.showResult("collection framework");
		assertEquals(expected.toString(), actual);
	}
	...
	void givenHelloWorldThenGetResult() {
		...
		String actual = charCounter.showResult("hello world!");
		assertEquals(expected.toString(), actual);
	}
